/* ============================================================
   Κέρκυρα rendering: φορτώνει kerkyra.json και κατασκευάζει όλα
   τα interactive elements
   ============================================================ */

(async function () {
  const data = await fetch('assets/data/kerkyra.json').then(r => r.json());
  ...
  if (data.mrb_overall) {
    ...
    const dests = ['Κέρκυρα','Κέρκυρα','Μύκονος','Βόλος-Πήλιο','Ναύπλιο'];
  ...
  if (data.mrb_cross) {
    ...
    const dest_pretty = ['Κέρκυρα','Κέρκυρα','Μύκονος','Βόλος-Πήλιο','Ναύπλιο'];
  ...
  function prettify(code) {
    const map = {
      'ΚΕΡΚΥΡΑ':'Κέρκυρα','ΧΑΝΙΑ':'Κέρκυρα','ΜΥΚΟΝΟΣ':'Μύκονος',
